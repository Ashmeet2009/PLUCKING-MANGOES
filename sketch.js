...
mango1 = new Mango(1280, 270, 80);
mango2 = new Mango(1150, 330, 60);
mango3 = new Mango(1250, 200, 70);
mango4 = new Mango(1350, 360, 90);
mango5 = new Mango(1000, 360, 70);
 
ground = new Ground(750, 750, 1500, 40);
stone= new Stone(250, 630, 40);
